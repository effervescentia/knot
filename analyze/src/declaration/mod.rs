    ...
    fn register_module() {
                        ...
                        Module::new(
                            ...
                            vec![f::n::dc(
                                f::a::const_(
                                    ...
                                    Some(f::n::txc(
                                        TypeExpression::Nil,
                                        NodeContext::new(2, vec![0, 1, 4])
                                    )),
                                    f::n::xc(
                                        Expression::Primitive(Primitive::Nil),
                                        NodeContext::new(3, vec![0, 1, 4])
                                    )
                                ),
                                NodeContext::new(4, vec![0, 1]),
                            )],
                        ),
                        NodeContext::new(5, vec![0, 1]),
                    )
                ),
                NodeContext::new(6, vec![0]),
            )
        );
        ...
        assert_eq!(
            ...
            FragmentMap::from_iter(vec![
                (
                    0,
                    (vec![0, 1, 2], Fragment::ImportSource(ImportSource::Root))
                ),
                (
                    1,
                    (
                ...
                (
                    2,
                    (vec![0, 1, 4], Fragment::TypeExpression(TypeExpression::Nil))
                ),
                (
                    3,
                    (
                ...
                (
                    5,
                    (vec![0, 1], Fragment::Module(Module::new(vec![1], vec![4])))
                ),
                (6, (vec![0], Fragment::Declaration(f::a::module("foo", 5))))
            ])
        );
    }
}
