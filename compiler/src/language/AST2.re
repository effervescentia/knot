 ...
 */
   ...
   */
    ...
    type style_rule_t = Style.StyleRule.node_t(raw_expression_t, type_t);
    type raw_style_rule_t = Style.StyleRule.t(raw_expression_t, type_t);
    ...
    type parameter_t = Lambda.Parameter.node_t(raw_expression_t, type_t);
    type raw_parameter_t = Lambda.Parameter.t(raw_expression_t, type_t);
