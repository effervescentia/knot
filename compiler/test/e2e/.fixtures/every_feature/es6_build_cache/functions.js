...
export { explicit_nil_function };
function implicit_nil_function() { };
export { implicit_nil_function };
function no_args_function() {
  return null;
};
export { no_args_function };
