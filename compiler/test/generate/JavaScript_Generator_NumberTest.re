...
let suite =
  ...
  >::: [
    "integer" >: (() => _assert_number(Number("123"), 123L |> A.of_int)),
    "integer - maximum"
    >: (
      () =>
        _assert_number(
          Number("9223372036854775807"),
          Int64.max_int |> A.of_int,
        )
    ),
    "integer - minimum"
    >: (
      () =>
        _assert_number(
          ...
          Int64.min_int |> A.of_int,
        )
    ),
    "float - zero"
    >: (() => _assert_number(Number("0"), (0.0, 0) |> A.of_float)),
    "float - one"
    >: (() => _assert_number(Number("1"), (1.0, 0) |> A.of_float)),
    "float - many significant digits"
    >: (() => _assert_number(Number("12345"), (12345.0, 5) |> A.of_float)),
    "float - fraction with many significant decimal digits"
    >: (() => _assert_number(Number("4.56"), (4.56, 3) |> A.of_float)),
    "float - fraction with significant decimal and non-decimal digits"
    >: (() => _assert_number(Number("1234.56"), (1234.56, 6) |> A.of_float)),
    "float - very small fraction"
    >: (
      () => _assert_number(Number("0.000456"), (0.000456, 6) |> A.of_float)
    ),
    "float - maximum"
    >: (
      () =>
