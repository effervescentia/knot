...
[![codecov](https://codecov.io/gh/effervescentia/knot/branch/master/graph/badge.svg?flag=jss-plugin)](https://codecov.io/gh/effervescentia/knot)

> A [`JSS`](https://cssinjs.org/) `style` plugin for the [`knot`](https://github.com/effervescentia/knot) compiler.
