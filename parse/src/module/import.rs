...
mod tests {
    ...
    fn import_named_empty() {
        assert_eq!(
            parse("use @/foo.{};").unwrap().0,
            f::n::ir(
                Import::new(ImportSource::Root, vec![str!("foo")], Some(vec![])),
                ((1, 1), (1, 3))
            )
        );
    }
            ...
            f::n::ir(
                Import::new(
                    ...
                    Some(vec![
                        ...
                        (ImportTarget::Named(str!("bar")), None)
                    ])
                ),
                ((1, 1), (1, 3))
            )
        ...
        assert_eq!(
            ...
            f::n::ir(
                Import::new(
                    ...
                    vec![str!("foo")],
                    Some(vec![
                        (ImportTarget::Module, Some(str!("foo"))),
                        (ImportTarget::Named(str!("fizz")), Some(str!("buzz")))
                    ])
                ),
                ((1, 1), (1, 3))
            )
