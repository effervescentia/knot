...
impl<Import, TypeDeclaration> Display for ast::TypeModule<Import, TypeDeclaration>
where
    Import: Display,
...
mod tests {
    ...
    mod type_expression {
        ...
        fn identifier() {
            assert_str_eq!(
                ast::shape::TypeExpression(ast::TypeExpression::Identifier(str!("foo")))
                    .to_string(),
                "foo"
            );
        }
